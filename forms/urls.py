...
from forms.views import (AssigneeList, FormCreate, FormDetails, FormDuplicate,
...
urlpatterns = [
    ...
    path('investigations/<slug:investigation_slug>/forms/<slug:form_slug>/duplicate',
         FormDuplicate.as_view(), name="interviewers_duplicate"),
    path('investigations/<slug:investigation_slug>/forms/<slug:form_slug>/change-status',
         FormChangeStatus.as_view(), name="interviewers_change_status"),
